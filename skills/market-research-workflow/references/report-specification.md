...
The Research execution plan names each action rather than repeating it. That short name is the action's whole first sentence when one genuinely ends and fits the column, and otherwise a clause or word-boundary truncation carrying a single trailing ellipsis. A sentence boundary is never a period inside a citation (FAR 19.502-2, 48 CFR 10.001, 13 C.F.R. 121.402), a decimal, or an abbreviation (U.S., e.g., No., Inc.), and a name never ends mid-word or mid-citation. Every Action cell must read as intelligible English on its own.
